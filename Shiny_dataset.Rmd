...
map_world3 <- distinct(map_world2)
map_world4 <- map_world3[,c("long","lat","region","Region")]
map_world5 <- map_world4[complete.cases(map_world4),]
map_world5
```
...
### Data for
      map_plot1 <- reactive({filter(map_world5,Region %in% input$region)})
...
### Tab 1 map      
      output$map1 <- renderPlotly(
     {
          ...
          g <- g + geom_map(data=map_plot1(), map=map_world5, aes(map_id=region, x=long, y=lat, fill="white"))
          print(g) 
